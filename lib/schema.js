...
const followReferences = (doc) => {
  ...
  } else if (getConfig(doc.schemaVersion, "keywordReference") && typeof doc.value === "string" && doc.pointer.endsWith("/$ref")) {
    return get(doc.value, doc);
  } else if (getConfig(doc.schemaVersion, "keywordRecursiveReference") && typeof doc.value === "string" && doc.pointer.endsWith("/$recursiveRef")) {
